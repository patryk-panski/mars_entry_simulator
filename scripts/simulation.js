    ...
    function update(type) {
      ...
      switch (type) {
        case 'mesh': {
          ...
          vehicle.name = 'MESH';
          // make parent child relationships between the objects
        ...
        case 'position': {
          // calculate new planet frame coordinates of the lander
